...
NOTE: The `mem` (`SystemMemoryUsage`) load metric has been removed since version 1.3, see https://issues.redhat.com/browse/MODCLUSTER-288[MODCLUSTER-288] for more context.
...
balancer/worker sends to/receives from. See https://issues.redhat.com/browse/MODCLUSTER-487[MODCLUSTER-487] for Apache HTTP Server behaviour
and https://issues.redhat.com/browse/MODCLUSTER-495[MODCLUSTER-495] for Tomcat's caveat.
...
Beware of https://issues.redhat.com/browse/MODCLUSTER-446[MODCLUSTER-446].
