...
// TODO: add a support matrix version/containers/etc
...
link:#UsingSSL[mod_ssl module] and link:#worker_config[explicit configuration in WildFly/JBoss AS/Web/Undertow].
