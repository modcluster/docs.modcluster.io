...
image:https://travis-ci.org/modcluster/docs.modcluster.io.svg?branch=master["Build Status", link="https://travis-ci.org/modcluster/docs.modcluster.io"] image:https://api.dependabot.com/badges/status?host=github&repo=modcluster/docs.modcluster.io["Dependabot Status", link="https://dependabot.com"]
